 ...
 */
final class Version20260107102033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assistant_cache (id INT AUTO_INCREMENT NOT NULL, profile_code VARCHAR(32) NOT NULL, question_hash VARCHAR(64) NOT NULL, response_json JSON NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE assistant_logs (id INT AUTO_INCREMENT NOT NULL, profile_code VARCHAR(32) NOT NULL, question_raw LONGTEXT NOT NULL, matched_qa_id INT DEFAULT NULL, fallback_used TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE assistant_qa (id INT AUTO_INCREMENT NOT NULL, profile_code VARCHAR(32) NOT NULL, question LONGTEXT NOT NULL, answer LONGTEXT NOT NULL, tags JSON NOT NULL, priority INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
