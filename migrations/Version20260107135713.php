 ...
 */
final class Version20260107135713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(160) NOT NULL, stack VARCHAR(200) NOT NULL, summary LONGTEXT NOT NULL, bulletin LONGTEXT NOT NULL, site_url VARCHAR(255) NOT NULL, repo_url VARCHAR(255) NOT NULL, image_url VARCHAR(255) DEFAULT NULL, duration VARCHAR(120) DEFAULT NULL, status VARCHAR(16) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
